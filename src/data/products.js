...
export const products = [
  ...
  name: "Ester",
  slug: "bolsa-ester",
  description: "Bolsa artesanal em crochê com design compacto e elegante. Seu formato estruturado e as alças longas proporcionam conforto para o uso diário, enquanto o acabamento em pontos verticais cria uma textura sofisticada e atemporal. Ideal para quem busca praticidade sem abrir mão do estilo.",
  price: 160.00,
  image: "/bolsaester.jpg",
  category: "premium",
  size: "Média",
  colors: ["Marrom Café"],
  inStock: true,
  ...
  name: "Maria",
  slug: "bolsa-maria",
  description: "Bolsa transversal artesanal em crochê com acabamento refinado e alça com detalhe em corrente. Seu formato retangular proporciona praticidade para carregar os itens essenciais do dia a dia, enquanto a textura trabalhada confere um visual moderno e sofisticado.",
  price: 160.00,
  image: "/bolsamaria.jpg",
  category: "premium",
  size: "Média",
  colors: ["Marrom Café"],
  inStock: true,
  ...
  name: "Gabi",
  slug: "bolsa-gabi",
  description: "Bolsa artesanal em crochê com visual clean e contemporâneo. Seu corpo amplo e estrutura macia oferecem excelente capacidade de armazenamento, enquanto as alças reforçadas garantem conforto e durabilidade. Uma peça versátil para acompanhar a rotina com elegância.",
  price: 190.00,
  image: "/bolsagabi.jpg",
  category: "premium",
  size: "Grande",
  ...
  },
  {
    id: 14,
    name: "Lei",
    slug: generateSlug("Lei"),
    description: "Design encantador feito a partir de motivos hexagonais que formam flores proeminentes. Combinação contrastante e elegante de tons creme e marrom escuro, finalizada com alça fina de couro e plaqueta exclusiva Ira Crochê.",
    price: 190.00,
    image: "/bolsalei.jpg",
    category: "premium",
    size: "Grande",
    colors: ["Creme", "Marrom Escuro", "Cor Personalizável"],
    inStock: true,
    featured: true,
  },
  {
    id: 15,
    name: "Lu",
    slug: generateSlug("Lu"),
    description: "Estilo retrô marcante com a clássica técnica dos 'granny squares' (quadrados da vovó). Um rico mosaico geométrico que une tons de marrom, terracota, amarelo suave e vinho. Possui alça de ombro confortável em crochê e fecho magnético prático.",
    price: 190.00,
    image: "/bolsalu.jpg",
    category: "premium",
    size: "Grande",
    colors: ["Multicolorida", "Marrom", "Terracota", "Cor Personalizável"],
    inStock: true,
    featured: true,
  },
  {
    id: 16,
    name: "Vitória",
    slug: generateSlug("Vitória"),
    description: "Estilo bolsa sacola com uma linda trama vazada geométrica em tom caramelo quente. Perfeita para o dia a dia, conta com alças de ombro estruturadas e um charmoso tassel lateral decorado com grandes contas de madeira natural.",
    price: 100.00,
    image: "/bolsavitoria.jpg",
    category: "premium",
    size: "Grande",
    colors: ["Caramelo", "Cor Personalizável"],
    inStock: true,
    featured: true,
  },
